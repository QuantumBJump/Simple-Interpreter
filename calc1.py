...
class Interpreter(object):
    ...
    def skip_whitespace(self):
        """As long as the current character is a space, just keep
        going."""
    ...
    def expr(self):
        ...
        # INTEGER MINUS INTEGER sequence of tokens has been 
        # successfully found and the method can just return the 
        # result of adding two integers, thus effectively
